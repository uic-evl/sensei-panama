...
colorBy.setInt(0)
selectedIndividual1 = Uniform.create('selectedIndividual1', UniformType.Int, 1)
...
chibi = createCustomGeom(f, scene, 'chibi')             #Ateles geoffroyi


chibiMat = chibi.getMaterial()
chibiMat.setProgram(moveLineProgram.name)
chibiMat.attachUniform(startDay)
chibiMat.attachUniform(endDay)
chibiMat.attachUniform(colorBy)
chibiMat.attachUniform(selectedIndividual1)
chibiMat.attachUniform(selectedIndividual2)


# f = open("gpsMovement/Abby.txt", "r")

# abby = createCustomGeom(f, scene, 'abby')             #Potos flavus

# abbyMat = abby.getMaterial()
# abbyMat.setProgram(moveLineProgram.name)
# abbyMat.attachUniform(startDay)
# abbyMat.attachUniform(endDay)

# f = open("gpsMovement/Clementina.txt", "r")

# clementina = createCustomGeom(f, scene, 'clementina')    #Nasua narica

# clemMat = clementina.getMaterial()
# clemMat.setProgram(moveLineProgram.name)
# clemMat.attachUniform(startDay)
# clemMat.attachUniform(endDay)
